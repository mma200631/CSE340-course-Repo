...
const showNewOrganaizationForm = async(req, res) => {
  const title= 'Add New Organaization';
...
if(!results.isEmpty())
{
  //Validation failed- lood through errors
  results.array().forEach((error)=>
  {
    req.flash('error', error.msg);
  });

  //Redirect back to the new organization page
...
export { showOrganizationPage, showOrganizationDetailsPage, showNewOrganaizationForm,processNewOrganizationForm, organizationValidation, 
